...
from transformers import AutoModelForSeq2SeqLM, NllbTokenizer, TextIteratorStreamer
from threading import Thread

MODEL_URL = "DinoDelija/nllb_english_german_fering_v2"
L1 = "eng_Latn"
L2 = "deu_Latn"
L3 = "fer_Latn"
LANGUAGES = {
...
def fix_tokenizer(tokenizer, new_lang=L3):
...
class Translator:
    def __init__(self):
        ...
        self.splitter = SentenceSplitter("de")
    ...
    async def stream(
        ...
        **kwargs,  
        ...
        generation_kwargs = dict(inputs, streamer=streamer, forced_bos_token_id=self.tokenizer.lang_code_to_id[tgt_lang])
        def generate_text():
